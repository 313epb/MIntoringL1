...
namespace Bcl.AttributeValuesExtraction
{
		...
		IComparable<CodeAuthorInfoAttribute>
	{
		...
		public CodeAuthorInfoAttribute(string name, string email)
		{
			...
			{
				throw new ArgumentException("The name mustn't be null or contain white spaces.");
			}

			if (string.IsNullOrWhiteSpace(email))
			{
				throw new ArgumentException("The email mustn't be null or contain white spaces.");
			}
